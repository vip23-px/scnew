...
REPO2="https://raw.githubusercontent.com/vip23-px/scnew/main/install/"
# initializing var
...
wget -O /etc/haproxy/haproxy.cfg "https://raw.githubusercontent.com/vip23-px/scnew/main/install/haproxy.cfg"
