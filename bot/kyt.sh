...
apt install -y git unzip dos2unix neofetch python3 python3-pip git wget curl figlet lolcat software-properties-common
...
unzip -P @Peyx23 kyt.zip -d /usr/bin/
cd /usr/bin/kyt
